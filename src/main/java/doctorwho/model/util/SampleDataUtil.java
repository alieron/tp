...
public class SampleDataUtil {
    public static Patient[] getSamplePatients() {
        return new Patient[]{
            ...
            new Patient(new Name("Bernice Yu"), new Nric("S2345678B"), new Phone("99272758"),
                        new Email("berniceyu@example.com"),
                        new Address("Blk 30 Lorong 3 Serangoon Gardens, #07-18"),
                        Set.of(new Allergy("Aspirin"), new Condition("Hypertension"))),
            new Patient(new Name("Charlotte Oliveiro"), new Nric("S3456789C"), new Phone("93210283"),
                        new Email("charlotte@example.com"),
                        new Address("Blk 11 Ang Mo Kio Street 74, #11-04"),
                        Set.of(new Condition("Asthma"))),
            new Patient(new Name("David Li"), new Nric("S4567890D"), new Phone("91031282"),
                        new Email("lidavid@example.com"),
                        new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                        Set.of(new Allergy("Ibuprofen"), new Allergy("Sulfonamides"))),
            new Patient(new Name("Irfan Ibrahim"), new Nric("S5678901E"), new Phone("92492021"),
                        new Email("irfan@example.com"),
                        new Address("Blk 47 Tampines Street 20, #17-35"),
                        Set.of(new Allergy("Aspirin"))),
            new Patient(new Name("Roy Balakrishnan"), new Nric("S6789012F"), new Phone("92624417"),
